...
export type SaveLocalPicturesParams = {
	pictures: Picture[]
	imageItems?: Map<string, ImageItem>
}

export async function saveLocalPictures(params: SaveLocalPicturesParams): Promise<Picture[]> {
	...
	const res = await fetch('/api/local-pictures', {
		method: 'POST',
		headers: { 'Content-Type': 'application/json' },
		body: JSON.stringify({ pictures, images: imagePayloads })
	})
