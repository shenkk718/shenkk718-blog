...
export function WriteEditor() {
	...
	return (
		<motion.div
			...
			className='bg-card flex h-[calc(100vh-5.25rem)] max-h-[720px] min-h-[520px] w-[min(720px,calc(100vw-380px))] flex-col rounded-[32px] border p-4 shadow'>
			<div className='mb-2 flex gap-2'>
				...
				<input
					...
					className='bg-card w-[180px] rounded-lg border px-3 py-1.5 text-sm'
					value={form.slug}
			...
			<textarea
				...
				className='bg-card min-h-0 w-full flex-1 resize-none overflow-y-auto rounded-xl border p-3 text-sm'
				value={form.md}
